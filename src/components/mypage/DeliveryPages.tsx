...
export function UnconfirmedDeliveryContent({
  ...
  async function openCaseDetail(doc: DeliveryDoc) {
    ...
    setCaseModal((data as CaseInfo) || {
      ...
      plaintiff: '윤서준', defendant: '주식회사 한빛이엔지',
      ...
      progress_history: [
        ...
        { date: '2026.04.16', content: '채권자대리인 법무법인 청솔에게 보정명령등본 송달', color: 'red', result: "위의 '확인' 항목 체크" },
        { date: '2026.04.20', content: '채권자 소송대리인 법무법인 청솔 이도현 사실조회 촉탁신청서(부산 해운대구청) 제출' },
        { date: '2026.04.21', content: '채권자 소송대리인 법무법인 청솔 이도현 보정기간연장 신청서 제출' },
        { date: '2026.04.24', content: '기타 부산 해운대구청에게 사실조회서 송달', color: 'red', result: "위의 '확인' 항목 체크" },
        { date: '2026.04.27', content: '채권자 소송대리인 법무법인 청솔 이도현 신청취지 및 신청이유 변경신청서 제출' },
        { date: '2026.04.28', content: '참여관용 기타' },
        { date: '2026.04.28', content: '채권자대리인 법무법인 청솔에게 보정명령등본 송달', color: 'red', result: "위의 '확인' 항목 체크" },
        { date: '2026.04.29', content: '채권자 소송대리인 법무법인 청솔 이도현 신청일부취하서 제출' },
        { date: '2026.04.30', content: '채권자 소송대리인 법무법인 청솔 이도현 증거설명서 제출' },
        { date: '2026.04.30', content: '채권자 소송대리인 법무법인 청솔 이도현 서증 제출' },
        { date: '2026.04.30', content: '담보제공명령' },
        { date: '2026.04.30', content: '채권자대리인 법무법인 청솔에게 담보제공명령등본 송달', color: 'red', result: "위의 '확인' 항목 체크" },
      ],
    } as CaseInfo)
  }
