    ...
    <div style={{ margin: 0, padding: 0, fontFamily: "'Malgun Gothic', '맑은 고딕', sans-serif", minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#f0f2f5' }}>
          ...
          {subtabs.map((tab, i) => (
            <button
              ...
              style={{
                ...
                background: 'transparent', color: activeSubtab === i ? '#1a3a6b' : '#555',
                fontWeight: activeSubtab === i ? 'bold' : 'normal', cursor: 'pointer', whiteSpace: 'nowrap',
              }}
            >
              {tab}
            </button>
      ...
      <div style={{ background: '#f7f9fc', borderBottom: '1px solid #e2e6ea' }}>
        <div style={{ maxWidth: 980, margin: '0 auto', padding: '8px 20px', fontSize: 12, color: '#888', display: 'flex', gap: 6, alignItems: 'center' }}>
          ...
          <span>민사서류 작성</span>
          <span>›</span>
          <span style={{ color: '#1a3a6b', fontWeight: 'bold' }}>답변서</span>
        </div>
      </div>
        ...
        <div style={{ maxWidth: 980, margin: '0 auto', padding: '16px' }}>
          ...
          {submitted ? (
            <div style={{
              ...
              <div style={{
                background: '#f0f7ff', border: '1px solid #c5d8f6', borderRadius: 6,
                padding: '14px 20px', maxWidth: 440, fontSize: 13, color: '#2952a3', lineHeight: 1.6,
              }}>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', justifyContent: 'center', marginTop: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 22px', fontSize: 14, cursor: 'pointer', fontWeight: 'bold',
                  }}
                >
                  나의 실습기록 확인하기
                </button>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 4, padding: '10px 22px', fontSize: 14, cursor: 'pointer',
                  }}
                >
                  새 답변서 작성하기
                </button>
